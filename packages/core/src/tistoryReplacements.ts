...
export const tistoryReplacements: TistoryReplacements = {
  "[##_title_##]": "티스토리 스킨 미리보기",
  "[##_image_##]": imgURL,
  "[##_description_##]": "티스토리 스킨 미리보기 예시입니다.",
  "[##_blogger_##]": "블로그 소유자 이름",
  "[##_blog_link_##]": "/",
  "[##_page_title_##]": "페이지 제목",
  "[##_blog_menu_##]": "블로그 메뉴 예시",
  "[##_body_id_##]": "tt_body-id",
